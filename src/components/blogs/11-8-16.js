  ...
  render() {
    return (
      <div className="first-blog">
        ...
        <h3 className="blog-question">What is OStM trying to fix?</h3>
          <p className="blog-p">Operation Spread the Music was created in response to
          ...
          for a cause greater than themselves
            ...
            <h3 className="blog-question">Why is OStM addressing this issue?</h3>
            <p className="blog-p">Segregation and isolation is a human issue.
            OStM hopes to provide a channel for human connection through outreach.
            </p>
            <h3 className="blog-question">Why should we care?</h3>
            <p className="blog-p">
            ...
            <iframe src="https://www.youtube.com/embed/8HLEr-zP3fc" allowFullScreen>
              ...
              <h2 className="success">Help us make this operation a success.</h2>

              <div className="sources">

              <p>Sources</p>
              <p className="blog-p">1. <a href="http://online.wsj.com/ad/article/longtermcare-future">The Wall Street Journal</a></p>
              <p className="blog-p">2. <a href='http://nursinghomediaries.com/howmany/'>Nursing Home Diaries</a></p>
              <p className="blog-p">3. <a href='https://assets.aarp.org/rgcenter/il/fs10r_homes.pdf'>AARP</a></p>
            </div>
          </div>
    );
  }
